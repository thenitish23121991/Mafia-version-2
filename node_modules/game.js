...
function remove_game(game,callback){
var result181 = games.remove({name:game});
result181.on('complete',function(err7,docs7){
console.log(docs7);
});
}
...
function get_players_count(game,callback){
console.log('get count method:'+game);
var players_count = 0;
var result171 = games.find({name:game});
result171.on('complete',function(err7,docs7){
<<<<<<< HEAD
console.log(docs7[0]);
=======
console.log('name:'+docs7[0].name+'wow');
>>>>>>> 4bca5a7b339074d1be0b3e9bbc48bb350f1d0cfe
console.log('get players count: '+docs7[0].users.length);
players_count = docs7[0].users.length;
callback(players_count);
});
}



function is_player_present_in_the_game(game,player_name,callback){
var player_result1;
console.log('is player present: '+player_name);
var player_result = games.find({name:game});
player_result.on('complete',function(err,docs){
docs[0].users.forEach(function(el,i){
if(docs[0].users[i].name == player_name){
player_result1 = 'present';
}else{
player_result1 = 'notpresent';
}
});
callback(player_result1);
});
}


function add_game_player(game,player,try_count){
console.log('add game player, game:'+game+' player:'+player+' try_count:'+try_count);
get_players_count(game,function(data191){
<<<<<<< HEAD
console.log('get player count: '+data191);
=======
console.log('get player count: '+game);
>>>>>>> 4bca5a7b339074d1be0b3e9bbc48bb350f1d0cfe
if(data191 != 10){
...
var user_json = {'name':player,'role':set_role,'status':'alive','awake':'true'};
...
var user_json = {'name':player,'role':set_role,'status':'alive','awake':'false'};
game_users.push(user_json);
...
function is_player_already_present(game,player,callback1){
var is_present = 'no';
console.log('is player already present called');
var result161 = games.find({name:game});
result161.on('complete',function(err7,docs7){
docs7[0].users.forEach(function(element,index){
console.log(docs7[0].users[index].name);
if(docs7[0].users[index].name == player){
is_present = 'yes';
}
});
callback1(is_present);
});
}
...
function get_alive_players(game,callback){
var alive_players = new Array();
var result131 = games.find({name:game});
result131.on('complete',function(err8,docs8){
docs8[0].users.forEach(function(element,index){
if(docs8[0].users[index].status == 'alive'){
alive_players.push(docs8[0].users[index]);
}
});
callback(alive_players);
});
}
...
if(role1 == 'mafia'){
var user_json = {'name':user,'role':role1,'status':'alive','player_type':'host','awake':'true'};
var god_json = {'name':'god','role':'god','status':'alive','player_type':'god','awake':'true'};
game_users.push(user_json);
game_users.push(god_json);
console.log(game_users);
var result12 = games.insert({name:name,users:game_users,mafias_count:1,citizens_count:0,detective_count:0,dacoit_count:0,healer_count:0,mafia_answers:mafia_answers,healer_healed:healer_healed,healer_killed:healer_killed,healer_answer:healer_answer,detective_answer:'',dacoit_answer:'',has_started:'no',started_at:started_at});
}else if(role1 == 'citizen'){
var user_json = {'name':user,'role':role1,'status':'alive','player_type':'host','awake':'false'};
var god_json = {'name':'god','role':'god','status':'alive','player_type':'god','awake':'true'};
game_users.push(user_json);
game_users.push(god_json);
console.log(game_users);
var result12 = games.insert({name:name,users:game_users,mafias_count:0,citizens_count:1,detective_count:0,dacoit_count:0,healer_count:0,mafia_answers:mafia_answers,healer_healed:healer_healed,healer_killed:healer_killed,healer_answer:healer_answer,detective_answer:'',dacoit_answer:'',has_started:'no',started_at:started_at});
}else if(role1 == 'healer'){
var user_json = {'name':user,'role':role1,'status':'alive','player_type':'host','awake':'false'};
var god_json = {'name':'god','role':'god','status':'alive','player_type':'god','awake':'true'};
game_users.push(user_json);
game_users.push(god_json);
console.log(game_users);
var result12 = games.insert({name:name,users:game_users,mafias_count:0,citizens_count:0,detective_count:0,dacoit_count:0,healer_count:1,mafia_answers:mafia_answers,healer_healed:healer_healed,healer_killed:healer_killed,healer_answer:healer_answer,detective_answer:'',dacoit_answer:'',has_started:'no',started_at:started_at});
...
game_users.push(god_json);
console.log(game_users);
var result12 = games.insert({name:name,users:game_users,mafias_count:0,citizens_count:0,detective_count:1,dacoit_count:0,healer_count:0,mafia_answers:mafia_answers,healer_healed:healer_healed,healer_killed:healer_killed,healer_answer:healer_answer,detective_answer:'',dacoit_answer:'',has_started:'no',started_at:started_at});
...
game_users.push(god_json);
console.log(game_users);
var result12 = games.insert({name:name,users:game_users,mafias_count:0,citizens_count:0,detective_count:0,dacoit_count:1,healer_count:0,mafia_answers:mafia_answers,healer_healed:healer_healed,healer_killed:healer_killed,healer_answer:healer_answer,detective_answer:'',dacoit_answer:'',has_started:'no',started_at:started_at});
}
...
<<<<<<< HEAD
console.log(game+'<br/>'+player_name);
is_player_already_present(game,player_name,function(data1901){
console.log('player: '+data1901);
if(data1901 != 'yes'){
=======
console.log('add player to game, game:'+game);
var is_player_present = is_player_present_in_the_game(game,player_name,function(docs12){
console.log('is player present: '+docs12);
if(docs12 == 'notpresent'){

var player_result = add_game_player(game,player_name);
if(typeof player_result == "undefined"){
console.log(player_result);
callback('player added');
}else{
callback(player_result);
}
}
...
get_live_games : function(number,callback){
console.log('request');
var skip_to = number*5;
...
var result1811 = get_alive_players(game,function(data1911){
console.log('alive: '+data1911.length);
var result3 = votes.find({game:game});
result3.on('complete',function(err3,docs3){
console.log('first vote length: '+docs3[0].first_vote.length);
if(docs3[0].first_vote.length >= data1911.length){
...
var result1811 = get_alive_players(game,function(data18191){
var result3 = votes.find({game:game});
result3.on('complete',function(err3,docs3){
console.log('err: '+err3);
console.log('alive: '+data18191.length);
console.log('final vote length: '+docs3[0].final_vote.length);
if(docs3[0].final_vote.length == data18191.length){
...
has_host_started_game : function(game,callback){
var has_started = 'no';
var result6 = games.find({name:game});
result6.on('complete',function(err9,docs9){
has_started = docs9[0].has_started;
callback(has_started);
});
},
...
var result121 = games.update({"users.name":player},{$set:{"users.$.status":'dead'}});
result121.on('complete',function(err2,docs2){
var result131 = games.update({"users.name":dacoit},{$set:{"users.$.status":'dead'}});
result131.on('complete',function(err3,docs3){
var result151 = games.update({name:game},{$set:{dacoit_answer:player}});
result151.on('complete',function(err4,docs4){
callback(docs3);
});
});
});
...
add_explain_yourself_message : function(game,player,message,callback){
var result131 = messages.insert({game:game,message:message,player:player,type:'explain'});
result131.on('complete',function(err6,docs6){
callback(docs6);
});
},
...
var result141 = messages.find({game:game,type:'explain'});
...
init_detective : function(game,callback){
var result151 = games.update({name:game},{$set:{detective_answer:''}});
result151.on('complete',function(err6,docs6){
callback('detective init');
});
},


has_dacoit_voted : function(game,callback){
var has_answered = 'no';
var result151 = games.find({name:game});
result151.on('complete',function(err7,docs7){
if(docs7[0].dacoit_answer.length > 0){
has_answered = 'yes';
}
callback(has_answered);
});
},

is_game_present : function(game,callback){
var is_game_present;
var result161 = games.find({name:game});
result161.on('complete',function(err6,docs6){
if(docs6.length > 0){
is_game_present = 'present';
}else{
is_game_present = 'game not present';
}
callback(is_game_present);
});
},

has_dacoit_killed_anyone : function(game,callback){
var result141 = games.find({name:game});
result141.on('complete',function(err7,docs7){
console.log(docs7[0].dacoit_answer);
if(docs7[0].dacoit_answer != ''){
callback('Dacoit has killed '+docs7[0].dacoit_answer);
}else{
callback('no action');
}
});
...
is_player_dead : function(game,player,callback){
var is_dead = 'no';
var result161 = games.find({name:game});
result161.on('complete',function(err8,docs8){
docs8[0].users.forEach(function(element,index){
if(docs8[0].users[index].name == player && docs8[0].users[index].status == 'dead'){
is_dead = 'yes'
}
});
callback(is_dead);
...
is_current_user_host : function(game,player,callback){
var is_host = 'no';
var result151 = games.find({name:game});
result151.on('complete',function(err3,docs3){
docs3[0].users.forEach(function(element,index){
if(docs3[0].users[index].name == player){
if(docs3[0].users[index].player_type == 'host'){
is_host = 'yes';
}
}
});
...
start_the_game : function(game,callback){
var result161 = games.update({name:game},{$set:{has_started:'yes'}});
result161.on('complete',function(err4,docs4){
callback(docs4);
});
},


has_game_expired : function(game,callback){
var time_since = '';
var result181 = games.find({name:game});
result181.on('complete',function(err6,docs6){
console.log('expired game: '+docs6[0]);
var started_1 = docs6[0].started_at;
var date = new Date;
var current_1 = date.getTime();
time_since = current_1-started_1;
var day = 1000*60*60*24;
console.log('time since: '+time_since+' current_1: '+current_1+' started_1 '+started_1);
if(time_since >= day){
remove_game(game,function(data1991){
callback('game removed');
});
}else{
callback('game not expired');
}
});
},


kickout_player : function(game,player,callback){
var game_users = new Array();
var new_game_users = new Array();
var json_index = 0;
console.log('kickout player called');
var result151 = games.find({name:game});
result151.on('complete',function(err8,docs8){
console.log('kickout: '+docs8);
game_users = docs8[0].users;
game_users.forEach(function(element,index){
console.log(game_users[index].name+' : player: '+player);
if(game_users[index].name != player){
new_game_users.push(game_users[index]);
}
});
console.log(new_game_users);
var result171 = games.update({name:game},{$set:{users:new_game_users}});
result171.on('complete',function(err9,docs9){
...
make_users_alive : function(game,type,callback){
var result1901 = games.find({name:game});
result1901.on('complete',function(err9,docs9){
callback(docs9);
});
},
...
dismiss_game : function(game,callback){
var result191 = games.remove({name:game});
result191.on('complete',function(err8,docs8){
callback('game dismissed');
});
},


add_night_message : function(game,message,player,callback){
var result181 = messages.insert({game:game,message:message,time:'night',player:player});
result181.on('complete',function(err9,docs9){
callback(docs9);
});
},

add_day_message : function(game,message,player,callback){
var result181 = messages.insert({game:game,message:message,time:'day',player:player});
result181.on('complete',function(err9,docs9){
callback(docs9);
});
},

get_night_messages : function(game,callback){
var result181 = messages.find({game:game,time:'night'});
result181.on('complete',function(err9,docs9){
callback(docs9);
});
},

get_day_messages : function(game,callback){
var result181 = messages.find({game:game,time:'day'});
result181.on('complete',function(err9,docs9){
callback(docs9);
});
},
...
is_player_alive_and_awake : function(game,player,callback){
var is_player = 'no'
var result191 = games.find({name:game});
result191.on('complete',function(err8,docs8){
docs8[0].users.forEach(function(element,index){
if(docs8[0].users[index].name == player){
if(docs8[0].users[index].status == 'alive' && docs8[0].users[index].awake == 'true'){
console.log('alive: '+docs8[0].users[index].status+' awake: '+docs8[0].users[index].awake);
is_player = 'yes';
}
}
});
...
make_players_awake : function(game,callback){
var result101 = games.find({name:game});
result101.on('complete',function(err9,docs9){
docs9[0].users.forEach(function(element,index){
if(docs9[0].users[index].role != 'mafia'){
var player_name = docs9[0].users[index].name;
var result121 = games.update({"users.name":player_name},{$set:{"users.$.awake":'true'}});
result121.on('complete',function(err78,docs78){
callback(docs78);
});
}
});
