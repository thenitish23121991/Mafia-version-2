...
game_users.push(user_json);
var result12 = games.insert({name:name,users:game_users,mafias_count:1,citizens_count:0,detective_count:0,dacoit_count:0,healer_count:0,mafia_answers:mafia_answers,healer_healed:healer_healed,healer_killed:healer_killed,healer_answer:healer_answer,detective_answer:'',dacoit_answer:''});
}else if(role1 == 'citizen'){
var user_json = {'name':user,'role':role1,'status':'alive'};
game_users.push(user_json);
var result12 = games.insert({name:name,users:game_users,mafias_count:0,citizens_count:1,detective_count:0,dacoit_count:0,healer_count:0,mafia_answers:mafia_answers,healer_healed:healer_healed,healer_killed:healer_killed,healer_answer:healer_answer,detective_answer:'',dacoit_answer:''});
}else if(role1 == 'healer'){
var user_json = {'name':user,'role':role1,'status':'alive'};
game_users.push(user_json);
var result12 = games.insert({name:name,users:game_users,mafias_count:0,citizens_count:0,detective_count:0,dacoit_count:0,healer_count:1,mafia_answers:mafia_answers,healer_healed:healer_healed,healer_killed:healer_killed,healer_answer:healer_answer,detective_answer:'',dacoit_answer:''});
}else if(role1 == 'detective'){
var user_json = {'name':user,'role':role1,'status':'alive'};
game_users.push(user_json);
var result12 = games.insert({name:name,users:game_users,mafias_count:0,citizens_count:0,detective_count:1,dacoit_count:0,healer_count:0,mafia_answers:mafia_answers,healer_healed:healer_healed,healer_killed:healer_killed,healer_answer:healer_answer,detective_answer:'',dacoit_answer:''});
